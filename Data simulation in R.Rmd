...
format: 
  revealjs:
    ...
    css: logo.css
    footer: <https://github.com/petermckenna/Data-Simulation>
...
-   I'm going to show you the syntax and calculations for simulating
    bivariate (i.e., includes two variables) data using R.
...
handw <- 
  read_csv("~/OneDrive - Heriot-Watt University/Teaching/MSc Programmes/MSc Social & Behavioural Research Methods/Courses/C91ED/Lectures/RStudio/data/heights_and_weights.csv", 
...
write_csv(all_data, "data/simulated_handw.csv")
